...
import 'chat/core/data/data_sources/auth_ds.dart';
import 'chat/core/data/data_sources/users_ds.dart';
import 'chat/core/domain/services/auth_service.dart';
import 'chat/core/domain/services/notifications_service.dart';
import 'chat/core/domain/services/users_service.dart';
import 'chat/features/call/data/data_sources/call_ds.dart';
import 'chat/features/call/domain/services/call_service.dart';
import 'chat/features/chat/data/data_sources/messages_ds.dart';
import 'chat/features/chat/data/data_sources/typing_ds.dart';
import 'chat/features/chat/domain/services/messages_service.dart';
import 'chat/features/groups/data/datasources/groups_ds.dart';
import 'chat/features/groups/domain/services/groups_service.dart';
...
Future<void> init () async {
  ...
  FirebaseFirestore.instance.enablePersistence(const PersistenceSettings(synchronizeTabs: true)).catchError((err) { // for web
