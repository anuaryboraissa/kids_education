...
class AddParticipantsController {
  ...
  final ValueNotifier<Map<String, Map<String,dynamic>>> notifySelectedUsers = ValueNotifier<Map<String, Map<String,dynamic>>>({});
  ...
  void _notifySelectedUsers() { 
    ...
    notifySelectedUsers.value = selectedUsers.map((uid, selected) => MapEntry(uid, {"user_public":_users!.firstWhere((element) => element.uid == uid),"bool":selected}));
  }
