    ...
    return notifySuccess.value || notifyIsLoading.value
        ...
        : () async {
            ...
            if (formKey.currentState!.validate()) {
              ...
              await getIt.get<GroupsService>().editGroupsTitle(
                    groupTitle: groupsNameController.text,
    ...
    return notifySuccess.value || notifyIsLoading.value
        ...
        : () async {
            ...
            if (formKey.currentState!.validate()) {
              ...
              conversation = await getIt.get<GroupsService>().createGroup(
                    groupTitle: groupsNameController.text,
                  );
              ...
              Future.delayed(const Duration(milliseconds: 1500), () {
                ...
                Navigator.of(navigatorKey.currentContext!).pushAndRemoveUntil(
                    MaterialPageRoute(
                      builder: (context) => AddGroupParticipantsScreen(
                        conversationId: conversation!.conversationId,
                      ),
                    ),
                    (route) => false);
