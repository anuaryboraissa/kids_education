...
import 'manage_group_participants_screen.dart';
...
final String? editExistingConversationId;
  const CreateGroupOrEditTitleScreen({Key? key, this.editExistingConversationId}) : super(key: key);
...
class _CreateGroupOrEditTitleScreenState extends State<CreateGroupOrEditTitleScreen> {
  ...
  void didChangeDependencies() {
    ...
    controller.initialize(editExistingConversationId: widget.editExistingConversationId,);
  ...
  Widget build(BuildContext context) {
    final isGroupCreation = widget.editExistingConversationId == null;
            ...
            children: [
              ...
              if (!isGroupCreation)
                ButtonWidget(
                  text: "MANAGE USERS",
                  onPressed: () {
                    Navigator.of(context).push(MaterialPageRoute(builder: (context) => ManageGroupParticipantsScreen(conversationId: controller.conversation!.conversationId,),)).then(Navigator.of(context).pop);
