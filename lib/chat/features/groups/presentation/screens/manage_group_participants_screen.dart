...
class ManageGroupParticipantsScreen extends StatefulWidget {
  ...
  const ManageGroupParticipantsScreen({super.key, required this.conversationId});
...
class _ManageGroupParticipantsScreenState extends State<ManageGroupParticipantsScreen> {
  ...
  void didChangeDependencies() {
    ...
    manageGroupParticipantsController.init(conversationId: widget.conversationId);
    initialized = true;
  }
        ...
        children: [
          ...
          Align(
            ...
            child: ButtonWidget(
              ...
              onPressed: () {
       Navigator.of(context).pushAndRemoveUntil(MaterialPageRoute(builder: (context) => AddGroupParticipantsScreen(conversationId: manageGroupParticipantsController.conversationId,),), (route) => false);
