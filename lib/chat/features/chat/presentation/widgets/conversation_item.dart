      ...
      child: Dismissible(
          ...
          child: InkWell(
            onTap: onTap ?? () {
              ...
              Navigator.of(context).push(MaterialPageRoute(builder: (context) => RealtimeChatScreen(conversationId: conversationId!, uidForDirectConversation: uidForDirectConversation),));
