...
import '../../controllers/users_to_talk_to_controller.dart';
    ...
    return MyScaffold(
      ...
      appBar: MyAppBarWidget(
        ...
        child: ConstrainedBox(
          constraints:  BoxConstraints(maxWidth: kPageContentWidth),
          child: Row(
            children: [
              Expanded(
              ...
              children: [
                ...
                StreamBuilder(
                  ...
                  builder: (context, snapshotContacts) {
                    ...
                    debugPrint("Snapshots data are as follows : ${snapshotContacts.data} ===========> ");
            ...
            return Padding(
              ...
              child: Visibility(
                ...
                child: FloatingActionButton.extended(
                  onPressed: () {
                     Navigator.of(context).push(MaterialPageRoute(builder: (context) => CreateGroupOrEditTitleScreen(),));
