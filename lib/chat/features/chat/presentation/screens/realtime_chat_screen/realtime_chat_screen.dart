...
import '../../controllers/realtime_chat_page_controller.dart';
...
class _RealtimeChatScreenState extends State<RealtimeChatScreen>
  ...
  void didChangeDependencies() {
    ...
    if (widget.uidForDirectConversation != null) {
      setState(() {
        loading = true;
      });
      WidgetsBinding.instance.addPostFrameCallback((_) {
        getIt
            ...
            .createConversationIfDoesntExists(
                uidForDirectConversation: widget.uidForDirectConversation!)
            .then((conversationId) {
    ...
    return MyScaffold(
        ...
        appBar: MyAppBarWidget(
          ...
          child: loading
              ? Container()
              : FutureBuilder(
                  future: getIt.get<MessagesService>().getConversationById(
                      conversationId: widget.conversationId),
